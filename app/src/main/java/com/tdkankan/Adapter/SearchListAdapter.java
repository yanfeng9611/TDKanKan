...
//        piclink= GlobalConfig.PicLinkCheck(piclink);
        ImageCacheManager.loadImage(picLink, holder.bookItem.img_pic,
                getBitmapFromRes(activity,R.drawable.nonepic),
                getBitmapFromRes(activity,R.drawable.nonepic));
...
//            intent.putExtra("picname",list.get(pos).get("picname"));
            ...
            intent.putExtra("newChapter",list.get(pos).get("newChapter"));
//            intent.putExtra("lastTime",list.get(pos).get("lastTime"));
//            intent.putExtra("chapterNum",list.get(pos).get("chapterNum"));
